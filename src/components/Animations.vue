                    ...
                    <defs>
                        ...
                        <g id="ball">
                          ...
                          <g id="plane">
                            ...
                            <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Fredoka One' font-size="34" fill="#0170BB"> Frontend Comparator </text>
...
export default {
    ...
    mounted() {
		this.loadTime = window.performance.now('Animations');
...
.animation1 .bird--three {
	animation-duration: 1.25s;
	animation-delay: -0.25s;
}
.animation1 .bird--four {
	animation-duration: 1.1s;
	animation-delay: -0.5s;
}
.animation1 .bird-container {
	position: absolute;
	top: 20%;
	left: -10%;
...
.animation1 .bird-container--one {
	animation-duration: 15s;
	animation-delay: 0;
}
.animation1 .bird-container--two {
	animation-duration: 16s;
	animation-delay: 1s;
}
.animation1 .bird-container--three {
	animation-duration: 14.6s;
	animation-delay: 9.5s;
}
.animation1 .bird-container--four {
	animation-duration: 16s;
...
.animation2 .credits a {
	background: #333;
	color: #fff;
	cursor: pointer;
}
.animation3 .store-container {
	line-height: 0;
	margin: 50px auto;
	width: 50%;
}
...
.animation3 .round-end {
	stroke-linecap: round;
}
.animation3 #store {
	animation: fadeIn 0.8s ease-in;
}
.animation3 .border-animation {
	background-color: white;
	border-radius: 10px;
	position: relative;
}
.animation3 .border-animation:after {
	content: "";
...
.animation3 #toldo, .animation3 .grass, .animation3 #window, .animation3 #door, .animation3 .trees, .animation3 .cat, .animation3 .cat-shadow, .animation3 .box, .animation3 .parachute, .animation3 .tshirt, .animation3 .cap, .animation3 .ball, .animation3 #text, .animation3 #button, .animation3 .sky-circle, .animation3 .sky-circle2, .animation3 .sky-circle3 {
	opacity: 0;
}
@keyframes pendulum {
	20% {
...
.animation3 .cat-shadow {
	transform-origin: 1115px 625px;
}
.animation3 #store:hover .cat {
	animation: catHi 3s 3s cubic-bezier(0.7, -0.5, 0.3, 1.4);
}
.animation3 #store:hover .cat-shadow {
...
.animation3 #text, .animation3 #button {
...
.animation4 .system__sun {
	position: absolute;
	top: 50%;
	left: 50%;
	transform: translate(-50%, -50%);
}
.animation4 .system__orbit {
	position: absolute;
	top: 50%;
	left: 50%;
...
.animation4 .system__orbit:nth-child(1) {
	width: calc(10%);
	height: calc(10%);
}
.animation4 .system__orbit:nth-child(2) {
	width: calc(20%);
	height: calc(20%);
}
.animation4 .system__orbit:nth-child(3) {
	width: calc(30%);
	height: calc(30%);
}
.animation4 .system__orbit:nth-child(4) {
	width: calc(40%);
	height: calc(40%);
}
.animation4 .system__orbit:nth-child(5) {
	width: calc(50%);
	height: calc(50%);
}
.animation4 .system__orbit:nth-child(6) {
	width: calc(60%);
	height: calc(60%);
}
.animation4 .system__orbit:nth-child(7) {
	width: calc(70%);
	height: calc(70%);
}
.animation4 .system__orbit:nth-child(8) {
	width: calc(80%);
	height: calc(80%);
}
.animation4 .system__orbit:nth-child(9) {
	width: calc(90%);
	height: calc(90%);
}
.animation4 .system__orbit:nth-child(10) {
	width: calc(100%);
	height: calc(100%);
}
.animation4 .system__orbit--sun {
	border: none;
}
.animation4 .system__orbit--mercury {
	animation-duration: 1s;
}
.animation4 .system__orbit--venus {
	animation-duration: 2.6s;
}
.animation4 .system__orbit--earth {
	animation-duration: 4.1s;
}
.animation4 .system__orbit--mars {
	animation-duration: 7.8s;
}
.animation4 .system__orbit--jupiter {
	animation-duration: 49.8s;
}
.animation4 .system__orbit--saturn {
	animation-duration: 120.3s;
}
.animation4 .system__orbit--uranus {
	animation-duration: 348.4s;
}
.animation4 .system__orbit--neptune {
	animation-duration: 684.4s;
}
.animation4 .system__orbit--pluto {
	animation-duration: 1028.6s;
}
.animation4 .system__planet {
	position: absolute;
	top: 50%;
	left: -12px;
	width: 25px;
